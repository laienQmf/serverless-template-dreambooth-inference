...
def download_model():
    ...
    s3 = boto3.resource(service_name='s3',endpoint_url='https://oss-cn-shenzhen.aliyuncs.com/',region_name='oss-cn-shenzhen', aws_access_key_id='LTAI5tRwn1RzJSUQgjeYEeqR', aws_secret_access_key='2NyzQeEWu9GmFIVnDlGDnHAZ6sy4WT')
